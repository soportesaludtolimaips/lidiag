                                ...
                                <div class="carousel-item active">
                                    <div class="container">
                                        <img class="d-block img-fluid"
                                            :src="ruta + '/admin-wrap/assets/images/big/img1.jpg'" alt="First slide">
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="container">
                                        <img class="d-block img-fluid"
                                            :src="ruta + '/admin-wrap/assets/images/big/img2.jpg'" alt="Second slide">
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="container">
                                        <img class="d-block img-fluid"
                                            :src="ruta + '/admin-wrap/assets/images/big/img3.jpg'" alt="Third slide">
                                    </div>
                                </div>
                            </div>
