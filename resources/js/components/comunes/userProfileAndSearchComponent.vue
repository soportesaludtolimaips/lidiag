                    ...
                    <ul>
                        ...
                        <li>
                            <div class="message-center">
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="<!-- {{ asset('admin-wrap/assets/images/users/1.jpg') }} -->"
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="<!-- {{ asset('admin-wrap/assets/images/users/2.jpg') }} -->"
                                            alt="user" class="img-circle">
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="<!-- {{ asset('admin-wrap/assets/images/users/3.jpg') }} -->"
                                            alt="user" class="img-circle">
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="<!-- {{ asset('admin-wrap/assets/images/users/4.jpg') }} -->"
                                            alt="user" class="img-circle">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <div class="container">
                                            <img class="d-block img-fluid"
                                                src="<!-- {{ asset('admin-wrap/assets/images/big/img1.jpg') }} -->"
                                                alt="First slide">
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <div class="container">
                                            <img class="d-block img-fluid"
                                                src="<!-- {{ asset('admin-wrap/assets/images/big/img2.jpg') }} -->"
                                                alt="Second slide">
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <div class="container">
                                            <img class="d-block img-fluid"
                                                src="<!-- {{ asset('admin-wrap/assets/images/big/img3.jpg') }} -->"
                                                alt="Third slide">
                                        </div>
                                    </div>
                                </div>
