...
class ConfigSedeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ConfigSede::create(['nom_sede' => 'La dorada - Hospital San Félix', 'ip_dcm' => '172.16.7.38', 'bd_dcm' => 'pacsdb', 'puerto_dcm' => '3306', 'usuario_dcm' => 'lidiag', 'password_dcm' => 'Lidiag', 'usuario_oviyam' => 'admin', 'password_oviyam' => 'admin', 'url_oviyam' => 'http://152.200.148.86:8888/oviyam2/viewer.html', 'tap_oviyam' => 'Servidor']);
        ConfigSede::create(['nom_sede' => 'Chaparral - Hospital San Jua Bautista', 'ip_dcm' => '186.170.28.80', 'bd_dcm' => 'pacsdb', 'puerto_dcm' => '3307', 'usuario_dcm' => 'lidiag', 'password_dcm' => 'Lidiag753...', 'usuario_oviyam' => 'admin', 'password_oviyam' => 'admin', 'url_oviyam' => 'http://186.170.28.80:8088/oviyam2/viewer.html', 'tap_oviyam' => 'Pacs']);
