...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::create(['num_docu' => '0000004', 'reg_med' => '', 'name' => 'ESTEFANIA HERMOSA', 'email' => 'hermosavida123@gmail.com', 'password' => bcrypt('123456')])->assignRole('Administrativo');
        ...
        User::create(['num_docu' => '0000001', 'reg_med' => '', 'name' => 'NELLY DIAZ  MONTOYA', 'email' => 'nelly_1408@hotmail.com', 'password' => bcrypt('123456')])->assignRole('Administrativo');
        User::create(['num_docu' => '0000002', 'reg_med' => '', 'name' => 'MARLEN TORRES RODRIGUEZ ', 'email' => 'rxsaludtolima2019@gmail.com', 'password' => bcrypt('123456')])->assignRole('Administrativo');
        ...
        User::create(['num_docu' => '00000005', 'reg_med' => '', 'name' => 'SALUD TOLIMA SAS SALUD TOLIMA SAS', 'email' => 'saludtolima@saludtolima.com', 'password' => bcrypt('123456')])->assignRole('Medico');
        ...
        User::create(['num_docu' => '0000003', 'reg_med' => '', 'name' => 'GERMÁN MORALES M', 'email' => 'germanmoralesm@hotmail.com', 'password' => bcrypt('123456')])->assignRole('Medico');
        ...
        User::create(['num_docu' => '0000006', 'reg_med' => '', 'name' => 'ESTADISTICA ESTADISTICA', 'email' => 'estadistica@estadistica.com', 'password' => bcrypt('123456')])->assignRole('Medico');
